...
public abstract class RelicSelectScreen implements RenderSubscriber, PreUpdateSubscriber, ScrollBarListener {
	private static final String MOD_ID = "RelicPoolFilter";
	...
	public RelicSelectScreen(boolean autoSort, boolean canSkip, boolean anyNum) {
		this(null, canSkip, null, null, null, autoSort, 1000000, anyNum);
	}
